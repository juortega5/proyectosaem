...
<div class="row">
  ...
  <div id="canvas" class=" col-md-10">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        <li id="indice" class="breadcrumb-item active" aria-current="page">Bienvenido Dr. <?php echo $datosLoguin[0]->primer_nombre.' '.$datosLoguin[0]->primer_apellido ?></li>
      </ol>
    </nav>
    <hr>
    <div class="alert alert-success" role="alert" id="bienvenida">
      ...
      <p>
        Para crear una cita médica seleccione la opción crear cita; si desea actualizar sus datos seleccione la opción actualizar información; para consultar o cancelar citas médicas seleccione la opción agenda.
      </p>
    </div>
    <div id="rta"></div>
    <div id="msj"></div>
